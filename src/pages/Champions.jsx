  ...
  return (
    ...
    <section className='champs flex justify-center items-center relative'>
      ...
      >
        ...
        >
          Bodybuilding isn't just a sport where you lift some weights 
          and have muscles . <br /> It's the way to push your limits and learn what displine really is
        </motion.h1>
        <motion.span 
        ...
        >"Winners do what they fear."</motion.span>
      </motion.div>
    </section>
