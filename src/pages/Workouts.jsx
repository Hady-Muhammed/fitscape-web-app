    ...
    <>
        <section className='lg:p-0 xs:p-5 workout flex justify-center items-center relative'>
            ...
            >
                ...
                >
                Anything worth achieving is gonna be hard <br /> , Facing ups
                and downs is inevitable, BUT this is <br /> what differentiate legends from normals!                </motion.h1>
                <motion.span 
                className="text-xl block italic"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 1, delay: 1.5 }}
                >"If you fail to PLAN , you're planning to FAIL"</motion.span>
            </motion.div>
